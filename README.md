...
1.__ETL [Data Extraction,Transformation,Loading]__  
...
A clear dashboard was build representing the all requirements that initially noted.Line graph and tables representing the trends in the Present % by Date,WFH%,SL%.
